//
//  TransferTestViewController.m
//  edum
//
//  Created by Md Chen on 20/6/2021.
...
@interface TransferTestViewController () <UITableViewDelegate, UITableViewDataSource, UIAlertViewDelegate>
...
@implementation TransferTestViewController
...
- (NSMutableArray *)array_data
{
    if (!_array_data) {
        NSArray *array = @[
                           @[
                               @[@"对方账户", @"戴法宽", @"action_about", @"1"],
                               @[@"", @"宁波银行股份有限公司", @"action_about", @"1"],
                               @[@"", @"6214180700100413341", @"action_about", @"1"],
                               @[@"摘要", @"合同首付款", @"action_about", @"1"],
                               @[@"交易账户", @"6217 **** **** 2678", @"action_about", @"1"],
                               @[@"币种", @"人民币", @"action_about", @"1"],
                               @[@"余额", @"129392.23", @"action_about", @"1"],
                               @[@"交易时间", @"2021-05-13 13:32:11", @"action_about", @"1"],
                               @[@"交易流水", @"WL142021051394210873826934", @"action_about", @"1"],
